  ...
  public async calculate(epoch: bigint) {
    return await this.prometheus.trackTask('calc-state-metrics', async () => {
      ...
      this.prometheus.validators.set(
        ...
        userValidatorsStats.active_ongoing,
      );
      this.prometheus.validators.set(
        {
          owner: Owner.USER,
      ...
      this.prometheus.validators.set(
        ...
        otherValidatorsStats.active_ongoing,
      );
      this.prometheus.validators.set(
        {
          owner: Owner.OTHER,
