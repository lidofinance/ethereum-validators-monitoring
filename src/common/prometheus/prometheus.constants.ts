...
export const METRIC_VALIDATOR_BALANCE_WITH_SYNC_PARTICIPATION_LESS_AVG_LAST_N_EPOCH = `validator_balance_with_sync_participation_less_avg_last_n_epoch`;
...
export const METRIC_HIGH_REWARD_VALIDATOR_BALANCE_WITH_SYNC_PARTICIPATION_LESS_AVG_LAST_N_EPOCH = `high_reward_validator_balance_with_sync_participation_less_avg_last_n_epoch`;
...
export const METRIC_HIGH_REWARD_VALIDATOR_BALANCE_MISS_ATTESTATION_LAST_N_EPOCH = `high_reward_validator_balance_miss_attestation_last_n_epoch`;
...
export const METRIC_VALIDATOR_BALANCE_INVALID_ATTESTATION_PROPERTY_LAST_N_EPOCH = `validator_balance_invalid_attestation_property_last_n_epoch`;
