...
export const METRIC_VALIDATORS_BALANCE = 'validators_balance';
export const METRIC_USER_VALIDATORS = 'user_validators';
export const METRIC_USER_VALIDATORS_BALANCE = 'user_validators_balance';
...
export const METRIC_VALIDATOR_BALANCE_WITH_NEGATIVE_BALANCES_DELTA = 'validator_balance_with_negative_balances_delta';
...
export const METRIC_OTHER_VALIDATOR_BALANCE_WITH_GOOD_SYNC_PARTICIPATION = 'other_validator_balance_with_good_sync_participation';
export const METRIC_VALIDATOR_COUNT_WITH_GOOD_SYNC_PARTICIPATION = 'validator_count_with_good_sync_participation';
export const METRIC_VALIDATOR_BALANCE_WITH_GOOD_SYNC_PARTICIPATION = 'validator_balance_with_good_sync_participation';
...
export const METRIC_OTHER_VALIDATOR_BALANCE_WITH_SYNC_PARTICIPATION_LESS_AVG = 'other_validator_balance_with_sync_participation_less_avg';
export const METRIC_VALIDATOR_COUNT_WITH_SYNC_PARTICIPATION_LESS_AVG = 'validator_count_with_sync_participation_less_avg';
export const METRIC_VALIDATOR_BALANCE_WITH_SYNC_PARTICIPATION_LESS_AVG = 'validator_balance_with_sync_participation_less_avg';
export const METRIC_VALIDATOR_COUNT_WITH_SYNC_PARTICIPATION_LESS_AVG_LAST_N_EPOCH =
  'validator_count_with_sync_participation_less_avg_last_n_epoch';
export const METRIC_VALIDATOR_BALANCE_WITH_SYNC_PARTICIPATION_LESS_AVG_LAST_N_EPOCH =
  'validator_balance_with_sync_participation_less_avg_last_n_epoch';
export const METRIC_HIGH_REWARD_VALIDATOR_COUNT_WITH_SYNC_PARTICIPATION_LESS_AVG_LAST_N_EPOCH =
  'high_reward_validator_count_with_sync_participation_less_avg_last_n_epoch';
export const METRIC_HIGH_REWARD_VALIDATOR_BALANCE_WITH_SYNC_PARTICIPATION_LESS_AVG_LAST_N_EPOCH =
...
export const METRIC_OTHER_VALIDATOR_BALANCE_PERFECT_ATTESTATION = 'other_validator_balance_perfect_attestation';
export const METRIC_VALIDATOR_COUNT_PERFECT_ATTESTATION = 'validator_count_perfect_attestation';
export const METRIC_VALIDATOR_BALANCE_PERFECT_ATTESTATION = 'validator_balance_perfect_attestation';
export const METRIC_OTHER_VALIDATOR_COUNT_MISS_ATTESTATION = 'other_validator_count_miss_attestation';
export const METRIC_OTHER_VALIDATOR_BALANCE_MISS_ATTESTATION = 'other_validator_balance_miss_attestation';
export const METRIC_VALIDATOR_COUNT_MISS_ATTESTATION = 'validator_count_miss_attestation';
export const METRIC_VALIDATOR_BALANCE_MISS_ATTESTATION = 'validator_balance_miss_attestation';
export const METRIC_VALIDATOR_COUNT_MISS_ATTESTATION_LAST_N_EPOCH = 'validator_count_miss_attestation_last_n_epoch';
export const METRIC_VALIDATOR_BALANCE_MISS_ATTESTATION_LAST_N_EPOCH = 'validator_balance_miss_attestation_last_n_epoch';
...
export const METRIC_HIGH_REWARD_VALIDATOR_BALANCE_MISS_ATTESTATION_LAST_N_EPOCH =
  'high_reward_validator_balance_miss_attestation_last_n_epoch';
export const METRIC_OTHER_VALIDATOR_COUNT_INVALID_ATTESTATION = 'other_validator_count_invalid_attestation';
export const METRIC_OTHER_VALIDATOR_BALANCE_INVALID_ATTESTATION = 'other_validator_balance_invalid_attestation';
export const METRIC_VALIDATOR_COUNT_INVALID_ATTESTATION = 'validator_count_invalid_attestation';
export const METRIC_VALIDATOR_BALANCE_INVALID_ATTESTATION = 'validator_balance_invalid_attestation';
export const METRIC_VALIDATOR_COUNT_INVALID_ATTESTATION_LAST_N_EPOCH = 'validator_count_invalid_attestation_last_n_epoch';
export const METRIC_VALIDATOR_BALANCE_INVALID_ATTESTATION_LAST_N_EPOCH = 'validator_balance_invalid_attestation_last_n_epoch';
...
export const METRIC_VALIDATOR_BALANCE_INVALID_ATTESTATION_PROPERTY_LAST_N_EPOCH =
  'validator_balance_invalid_attestation_property_last_n_epoch';
export const METRIC_VALIDATOR_COUNT_HIGH_INC_DELAY_ATTESTATION_LAST_N_EPOCH = 'validator_count_high_inc_delay_last_n_epoch';
export const METRIC_VALIDATOR_BALANCE_HIGH_INC_DELAY_ATTESTATION_LAST_N_EPOCH = 'validator_balance_high_inc_delay_last_n_epoch';
export const METRIC_OTHER_VALIDATOR_COUNT_GOOD_PROPOSE = 'other_validator_count_good_propose';
export const METRIC_OTHER_VALIDATOR_BALANCE_GOOD_PROPOSE = 'other_validator_balance_good_propose';
export const METRIC_VALIDATOR_COUNT_GOOD_PROPOSE = 'validator_count_good_propose';
export const METRIC_VALIDATOR_BALANCE_GOOD_PROPOSE = 'validator_balance_good_propose';
export const METRIC_OTHER_VALIDATOR_COUNT_MISS_PROPOSE = 'other_validator_count_miss_propose';
export const METRIC_OTHER_VALIDATOR_BALANCE_MISS_PROPOSE = 'other_validator_balance_miss_propose';
export const METRIC_VALIDATOR_COUNT_MISS_PROPOSE = 'validator_count_miss_propose';
export const METRIC_VALIDATOR_BALANCE_MISS_PROPOSE = 'validator_balance_miss_propose';
export const METRIC_HIGH_REWARD_VALIDATOR_COUNT_MISS_PROPOSE = 'high_reward_validator_count_miss_propose';
export const METRIC_HIGH_REWARD_VALIDATOR_BALANCE_MISS_PROPOSE = 'high_reward_validator_balance_miss_propose';
...
export const METRIC_OTHER_VALIDATOR_CONSOLIDATION_COUNT = 'other_validator_consolidation_count';
export const METRIC_OTHER_VALIDATOR_CONSOLIDATION_BALANCE = 'other_validator_consolidation_balance';
export const METRIC_VALIDATOR_CONSOLIDATION_COUNT = 'validator_consolidation_count';
export const METRIC_VALIDATOR_CONSOLIDATION_BALANCE = 'validator_consolidation_balance';
